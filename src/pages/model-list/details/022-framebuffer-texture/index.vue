...
<template>
  <div class="framebuffer-texture-page">
    <Page title="framebuffer-texture">
...
export default defineComponent({
  ...
  methods: {
    // 渲染入口
    render() {
      objModel = new Model(this.$refs.container as HTMLDivElement, this.$refs.selection as HTMLDivElement);
      objModel.init();
    },
