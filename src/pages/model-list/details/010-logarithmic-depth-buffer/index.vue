...
<template>
  <div class="logarithmic-depth-buffer-page">
    <Page title="logarithmic-depth-buffer">
        ...
        <div class="settings-content">
          <Block title="1. 状态">
            <Space size="1rem" wrap>  
              <Button size="small" type="primary">perspective</Button>
              <Button size="small" type="primary">orthographic</Button>
            </Space>
          </Block>
