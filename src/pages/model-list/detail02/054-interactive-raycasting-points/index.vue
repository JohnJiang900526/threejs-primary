...
<template>
  <div class="webgl-interactive-raycasting-points-page">
    <Page title="webgl-interactive-raycasting-points">
...
<style lang='less' scoped>
  ...
  .webgl-interactive-raycasting-points-page {
    .absolute-page();
