...
<template>
  <div class="webgl-loader-gltf-sheen-page">
    <Page title="webgl-loader-gltf-sheen">
        ...
        <div class="settings-content">
          <Block title="sheen">
            <div class="item-param slider">
              <Slider 
                v-model="sheen" :min="0" :max="1" :step="0.01" 
                @change="sheenChange" 
...
export default defineComponent({
  ...
  methods: {
    ...
    sheenChange(val: number) {
      if (objModel) {
        this.closeHandle();
        objModel.setSheen(val);
      }
    },
