...
<template>
  <div class="webgl-loader-3mf-page">
    <Page title="webgl-loader-3mf">
    ...
    <Popup :show="show" position="right" @click-overlay="closeHandle" :style="{ height: '100%', width: '80%' }">
      <Page @click-left="closeHandle" :default-click="false" title="模型设置">
        <div class="settings-content">
          <Block title="设置asset">
            <radio-group v-model="asset" @change="assetChange">
              <div v-for="item in assets" :key="item" class="item-param">
