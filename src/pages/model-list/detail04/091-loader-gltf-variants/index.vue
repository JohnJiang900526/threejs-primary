...
<template>
  <div class="webgl-loader-gltf-variants-page">
    <Page title="webgl-loader-gltf-variants">
    ...
    <Popup :show="show" position="right" @click-overlay="closeHandle" :style="{ height: '100%', width: '80%' }">
      <Page @click-left="closeHandle" :default-click="false" title="模型设置">
        <div class="settings-content">
          <Block title="Variant">
            <radio-group v-model="variant" @change="variantChange">
              <div v-for="item in variants" :key="item" class="item-param">
...
import { Model, type VariantType } from "./tools";
...
export default defineComponent({
  ...
  methods: {
    ...
    variantChange(variant: VariantType ) {
      if (objModel) {
        this.closeHandle();
        objModel.setVariant(variant);
      }
    },
...
<style lang='less' scoped>
  ...
  .webgl-loader-gltf-variants-page {
    .absolute-page();
